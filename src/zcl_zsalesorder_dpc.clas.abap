...
protected section.
  ...
  methods SALESORDERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSALESORDER_MPC=>TS_SALESORDER
    raising
  ...
  methods SALESORDERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSALESORDER_MPC=>TT_SALESORDER
...
*&* This class has been generated on 30.01.2026 14:18:56 in client 001
*&*
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_create_entity TYPE zcl_zsalesorder_mpc=>ts_salesorder.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE zcl_zsalesorder_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSALESORDER_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE zcl_zsalesorder_mpc=>tt_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE zcl_zsalesorder_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*      method = 'SALESORDERSET_GET_ENTITYSET'
  ...
  "Interne Tabelle passend zum Typ des EntitySets

  "Daten aus Composite View Z_C_Sales selektieren
