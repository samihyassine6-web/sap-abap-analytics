class ZCL_ZSALESORDER_DTL_DPC definition
  public
...
protected section.
  ...
  methods SALESORDERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSALESORDER_DTL_MPC=>TS_SALESORDER
    raising
  ...
  methods SALESORDERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSALESORDER_DTL_MPC=>TT_SALESORDER
...
CLASS ZCL_ZSALESORDER_DTL_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 29.01.2026 23:23:07 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZSALESORDER_DTL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderset_create_entity TYPE zcl_zsalesorder_dtl_mpc=>ts_salesorder.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE zcl_zsalesorder_dtl_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSALESORDER_DTL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE zcl_zsalesorder_dtl_mpc=>tt_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE zcl_zsalesorder_dtl_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
