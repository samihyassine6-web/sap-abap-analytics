class ZCL_ZSALESORDER_DTL_01_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSALESORDER_DTL_01_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZSALESORDER_DTL_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSALESORDER_DTL_SRV_01' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260130113415'.                  "#EC NOTEXT
