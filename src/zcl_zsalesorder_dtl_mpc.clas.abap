class ZCL_ZSALESORDER_DTL_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSALESORDER_DTL_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZSALESORDER_DTL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSALESORDER_DTL_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260129222300'.                  "#EC NOTEXT
