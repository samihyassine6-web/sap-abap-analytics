class ZCL_Z_SALES_SRV_MPC definition
  public
...
public section.
  ...
  types:
     TS_SALES type ZISALES .
  types:
TT_SALES type standard table of TS_SALES .
  types:
  ...
  constants GC_SALES type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'sales' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_SALES_SRV_MPC===========CP' ##NO_TEXT.

  methods DEFINE_SALES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_SALES_SRV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_SALES_SRV_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'sales' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZISALES'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'salesSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260129212727'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'sales'.                            "#EC NOTEXT
